...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info','El rol se ha creado con éxito');
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info','El rol se ha actualizado con éxito');
    }
