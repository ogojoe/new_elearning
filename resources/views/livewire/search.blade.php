<form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
    <input wire:model="search" class="w-full border-2 border-gray-300 bg-white h-10 px-5 pr-16 text-sm focus:outline-none"
    ...
    @if ($search)
    <ul class="absolute z-50 left-0 w-full bg-white mt-1 overflow-hidden">
