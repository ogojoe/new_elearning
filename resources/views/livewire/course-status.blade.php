<div class="mt-8">
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            <div class="embed-responsive">
                <h1>Disculpa las molestias, este curso no tiene actividades cargadas, favor de comunicarse con el administrador del sistema.</h1>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="relative pt-1">
                    <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200">
                      <div style="width:" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-emerald-500 transition-all duration-500"></div>
                    </div>
                  </div>
